...
html"""
<p style="font-size:20px;">Team Abhi: Abi Jo Wanek, Ishaan Ratliff, Zach Marshall, Sid Bhatt</br>
...
Our goal for this project was to design a bioprocess to synthesize hyrdrazine with xylan (or d-xylose) as our feedstock. The other reactants necessary for our process were nitric oxide, ammonia, and oxygen. Below is some background information on each reactant and their uses.

**D-Xylose:**

Xylose is a parent sugar alcohol from which another sugar alcohol - xylitol- can be derived from and used as an extremely common food additive or sweetener to be used in place of regular sugars as a lower calorie alternative. D-xylose is stored as an aqueous solution, and in very low molarities, which is reflected in the very low flow rate into each individual chip for our reaction. (5)

**Ammonia:**

Ammonia (NH3) is one of the most commonly produced industrial chemicals in the United States. It is used in industry and commerce, and also exists naturally in humans and in the environment. Ammonia is essential for many biological processes and serves as a precursor for amino acid and nucleotide synthesis. In the environment, ammonia is part of the nitrogen cycle and is produced in soil from bacterial processes. Ammonia is also produced naturally from decomposition of organic matter, including plants, animals and animal wastes. For our experiment this is reflected in the relatively inexpensive cost of Ammonia due to its ease of access, but is slightly expensive due to the fact it needs to be stored at low temperatures. (1)

**Nitric Oxide:**

This gas is an important signaling molecule in the body of mammals including humans and is an extremely important intermediate in the chemical industry. It is also a toxic air pollutant produced by automobile engines and power plants. The nitric oxide molecule is a free radical, which is relevant to understanding its high reactivity. It reacts with the ozone in air to form nitrogen dioxide, signalled by the appearance of the reddish-brown color. Therefore, it costs a significant amount to store responsibly, resulting in this starting material to be the primary contributor to the high cost of our set up. (3)

**Hydrazine:**

Our product, hydrazine, is a very interesting compound with many applications in the real world. Hydrazine, (N2H4) appears as a colorless, fuming oily liquid with an ammonia-like odor. It is flammable and corrosive to tissue. It is toxic by inhalation and by skin absorption, and it produces toxic oxides of nitrogen during combustion. It also explodes during distillation if traces of air are present. Hydrazine is a highly reactive base and reducing agent used in many industrial and medical applications. Hydrazine exhibits antidepressant properties, however it is rarely used in psychiatry. It is primarily used in agricultural chemicals (pesticides), chemical blowing agents, pharmaceutical intermediates, photography chemicals, boiler water treatment for corrosion protection, textile dyes, and as fuel for rockets and spacecraft. (4)

**Product Applications:**

*Foaming Agents*

The primary application of hydrazine is to produce foaming agents: a chemical substance that facilitates the reaction to make different types of foam. The most common foaming agent that hydrazine is chemically involved in is azodicarbonamide. Azodicarbonamide is used to produce many different cooking ingredients, such as the whitening agent in flour or the dough conditioner in bread. Chemically speaking, the production of azodicarbonamide is initiated by the condensation reaction between hydrazine sulfate, created by reacting hydrazine with sulfate, and urea. Then, the product of this reaction is oxidized by NaOCl, which produces the desired product. However, hydrazine is not limited to use in the kitchen, it can be used to create polymer foams that can be used to make insulation panels for homes, and even spandex. (6)

*Versatile Fuel*

Hydrazine is used to make pesticides and pharmaceuticals. Although it is toxic to us directly, hydrazine rapidly breaks down in oxygen, making release into the environment low risk. It could even be considered an environmentally friendly fuel. Hydrazine breaks down to make nitrogen and water and gives out energy in an exothermic reaction. It produces a little more energy than hydrogen, is easier to store because it’s a liquid at room temperature, and avoids the need for an expensive platinum catalyst. Hydrazine can also be found in fossil fuels and nuclear power stations. As a powerful reducing agent, it acts as an oxygen scavenger, reducing metal oxides back into metals, and literally turning the chemical clock back on corrosion processes. The explosive nature of hydrazine has been put to good use, too. Sodium azide, the compound that activates car air bags, is manufactured directly from hydrazine and sodium nitrate. (2)

*Rocket Chemistry*

Hydrazine is also used as rocket fuel propellant. Mixing it with oxidising agent dinitrogen tetroxide, N2O4, creates a hypergolic mixture – a mixture so explosive, no ignition is required. As the fuel burns, three reactions take place, decomposing hydrazine into ammonia, nitrogen and hydrogen gases, which are forced out of the rocket through a tight nozzle to create thrust. Today, some military vehicles use hydrazine, but it is employed mostly in extraterrestrial exploration. The Curiosity Rover, which has been resident on Mars since 2012, used hydrazine to land on the red planet. And, in July this year, the NASA New Frontiers mission ‘Juno’ made its incredible insertion into the orbit of Jupiter powered by hydrazine and dinitrogen tetroxide. (2)

(see all sources for the above information at the bottom of this notebook)
...
begin
	...
	compounds_that_we_need_to_supply_feed_1 = [
		"oxygen", "d-xylose", "nitric oxide", "ammonia"
	]

	# what are the amounts that we need to supply to chip in feed stream 1 (units: mmol/hr)?
	mol_flow_values_feed_1 = [
		10.0 	; # oxygen mmol/hr
		1.233 	; # d-xylose mmol/hr 
		2.466	; # nitric oxide mmol/hr
		2.466 	; # ammonia mmol/hr
	]
...
*Simplifying Assumption:* For this project we made the assumption that the flow rate of our pump wouldn't interfere with the molarity of our solutions, meaning we wouldn't need to adjust the molarity to take into account if reactants were precipitating out of solution, and our mL/min in from the pump would work in conjunction with our mmol/hr being fed into the chips.
"""
...
begin
	...
	mass_flow_into_seps = mass_dot_output_array*52
...
# ╔═╡ 5dfd9f65-07d5-470f-b568-d4ac7501d77f
md"""
## Results and Discussion

##### Financial Performance:

###### Production cost per Gram of Hydrazine:


"""

# ╔═╡ edc2e5e7-c22b-49a5-9506-b86a72b84f3a
with_terminal() do

	data = ["D-xylose" "X1500" "9.626" "0.248" "2.39";
                    
            "Nitric Oxide"     295566      3.85    32.13 	123.61 ;
            "Ammonia"    294993     2.184    3.729	 	8.144 ;
            "Oxygen"     "N/A"      "N/A"    "N/A" 	"N/A" ;]
                    

	state_table_header_row = (["Reactant","Product Number","Grams Needed", "Price", "Total Cost"],
			["","(from Sigma Aldrich)","g/hr", "USD/gram", "USD/hr"]);


pretty_table(data; header=state_table_header_row)

end

# ╔═╡ 934854e5-5657-49eb-b23e-8ad37d4deb70
md"""

##### Calculations: 

**D-Xylose:** 52 chips $$(\frac{1.233 mmol}{1 hr})(\frac{1mol}{1000mmol})(\frac{150.13 g}{1 mol})(\frac{1 kg}{1000g})(\frac{$248}{1 kg})= 2.39 \hspace{2mm}USD/hr$$

**Nitric Oxide:** 52 chips $$(\frac{2.466 mmol}{1 hr})(\frac{1mol}{1000mmol})(\frac{30 g}{1 mol})(\frac{1 L}{1.34 g})(\frac{$721}{16.745 L})= 123.61 \hspace{2mm}USD/hr$$

**Ammonia:** 52 chips $$(\frac{2.466 mmol}{1 hr})(\frac{1mol}{1000mmol})(\frac{17.03 g}{1 mol})(\frac{$634}{170 g})= 8.144 \hspace{2mm}USD/hr$$

We can sell Hydrazine for **2.46 USD/hr**, which when combined with the sum of our reactant costs leaves us with a net profit of:  -131.69 USD/hr or **-1,153,604.40 USD/ yr**


###### Alternative Investment Calculations:

$$CF_{1}=Initial Investment=52 chips($100)+6separators($20)+1 syringe pump($1,000)=$6,320$$

$$d_{i,1}=(1.10)^{i-1}$$ in the equation $$d_{i,1}$$ above let r=0.10, 10% alternative investment rate

$$CF_{i}=-$1,153,604.4/yr\qquad{i=2,3,4,5,6}$$
...
This is obviously a very negative NPV and shows that our synthesis of Hydrazine is not a good financial investment in comparison to a 10% alternative investment rate.
...
From the Net Present Value calculation, it was determined that, over five years, the system would yield $4,448,438.24 USD less than an investment of the starting amount, $6,320 USD, at a 10% interest rate. From this, we determined that our system is not economically viable. Therefore, producing Hydrazine from Xylan would not be feasible. The key reactant in the feed that contributes to the large cost of production is nitric oxide, which costs $123.61 USD an hour to feed into the system. Nitric oxide contributes to about 92% of the supply feed cost. 
	$$\hspace{2mm}$$

An alternative reaction that produces hydrazine in a more economically viable manner -- without nitric oxide as a reactant -- is the reaction of ammonia and chlorine gas shown in the reaction below:
$$\hspace{1mm}$$

Cl2 + 2NH3 → NH2Cl + NH4Cl (fast)
NH2Cl + 2NH3 → N2H4 + NH4Cl (slow)
$$\hspace{1mm}$$

Chlorine gas is far cheaper than nitric oxide gas --- while one gram of nitric oxide costs $32.18 USD, one gram of Cl2 costs 1.18 USD, which is nearly 27 times cheaper. Additionally, the NH4Cl produced during the reaction could also be isolated and sold for less than two dollars per gram. Supplying only ammonia and chlorine gas into our feed is a far more viable way of producing hydrazine when compared to using xylan, as the cost to run the system per time would be significantly reduced. Because of this we recommend using this process to produce the hydrazine needed instead of the process that we designed with our given constraints. (7)
...
(1) “Department of Health.” The Facts About Ammonia, [https://www.health.ny.gov/environmental/emergency/chemical_terrorism/ammonia_tech.htm](https://www.health.ny.gov/environmental/emergency/chemical_terrorism/ammonia_tech.htm). 

(2) Fletcher-Wood2016-08-03T00:00:00+01:00, Rowena. “Hydrazine.” RSC Education, 3 Aug. 2016, [https://edu.rsc.org/magnificent-molecules/hydrazine/2000023.article](https://edu.rsc.org/magnificent-molecules/hydrazine/2000023.article). 

(3) National Center for Biotechnology Information. "PubChem Compound Summary for CID 145068, Nitric oxide" PubChem, [https://pubchem.ncbi.nlm.nih.gov/compound/Nitric-oxide](https://pubchem.ncbi.nlm.nih.gov/compound/Nitric-oxide). Accessed 17 December, 2021.

(4) National Center for Biotechnology Information. "PubChem Compound Summary for CID 9321, Hydrazine" PubChem, [https://pubchem.ncbi.nlm.nih.gov/compound/Hydrazine](https://pubchem.ncbi.nlm.nih.gov/compound/Hydrazine). Accessed 17 December, 2021.

(5) National Center for Biotechnology Information. "PubChem Compound Summary for CID 135191, D-Xylose" PubChem, [https://pubchem.ncbi.nlm.nih.gov/compound/D-Xylose](https://pubchem.ncbi.nlm.nih.gov/compound/D-Xylose). Accessed 17 December, 2021.
 
 
(6) Center for Food Safety and Applied Nutrition. “Azodicarbonamide Frequently Asked Questions.” U.S. Food and Drug Administration, FDA, [https://www.fda.gov/food/food-additives-petitions/azodicarbonamide-ada-frequently-asked-questions](https://www.fda.gov/food/food-additives-petitions/azodicarbonamide-ada-frequently-asked-questions). 

(7) Mattair, Robert, and Harry H. Sisler. “The Production of Hydrazine by the Reaction of Chlorine 
with Anhydrous ammonia1.” Journal of the American Chemical Society, vol. 73, no. 4, 
1951, pp. 1619–1622., [https://doi.org/10.1021/ja01148a061](https://doi.org/10.1021/ja01148a061). 
